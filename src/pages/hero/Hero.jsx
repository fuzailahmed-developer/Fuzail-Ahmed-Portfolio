    ...
    return (
      <div className="flex flex-col md:flex-row items-center justify-center h-screen">
        ...
        <div className="md:w-2/4 flex md:flex flex-col items-start justify-center">
          ...
          <div className="flex flex-col items-start md:flex-row md:items-start mb-4 md:mb-8 mx-auto md:mx-0 md:[&>*]:w-auto [&>*]:w-full">
            <Button
              onClick={() =>
                handleButtonClick(
                  "https://drive.google.com/file/d/1xzgpJgi8NvvC4Qs-PDXqM3be0Amn_znI/view?usp=drive_link"
                )
              }
              ripple={true}
